...
//        glDisable(GL_DEPTH_TEST);
    if (glfwGetKey(gWindow, '1') == GLFW_RELEASE) {
        iDepth = !iDepth;
    }else if (glfwGetKey(gWindow, '2') == GLFW_RELEASE){
        iCull = !iCull;
    }else if (glfwGetKey(gWindow, '3') == GLFW_RELEASE){
        glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
    }else if (glfwGetKey(gWindow, '4') == GLFW_RELEASE){
        glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    }else if (glfwGetKey(gWindow, '5') == GLFW_RELEASE){
